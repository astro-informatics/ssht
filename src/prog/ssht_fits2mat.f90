...
! ssht_fits2mat
!
!! Converts a fits SSHT file containing wavelet and scaling coefficients 
!! to a matlab SSHT file.
!! 
!! Usage: ssht_fits2mat
!!   - [-help]: Displays usage information.
!!   - [-inp filename_in]: Name of input fits SSHT file. 
!!   - [-out filename_out]: Name of output matlab SSHT m file.
!     
...
program ssht_fits2mat
  ...
  ! Read wavelet and scaling coefficients from fits file.
  call ssht_fileio_fits_wav_read(wavdyn, scoeff, J, B, N, bl_scoeff, &
       alpha, filename_in)

  ! Write wavelet and scaling coefficients to matlab file.
    ...
    subroutine parse_options()
      ...
      do i = 1,nn,2
        ...
        select case (trim(opt))
          ...
          case ('-help')
            write(*,'(a)') 'Usage: ssht_fits2mat [-inp filename_in]'
