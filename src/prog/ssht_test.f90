...
!!$        call ssht_core_mw_inverse_real_precomp(f_mw_real, &
!!$             f_real_sp_mw, flm_orig, L, dlmn, verbosity)
...
!!$        call ssht_core_mw_forward_real_precomp(flm_syn, &
!!$             f_mw_real, f_real_sp_mw, L, dlmn, verbosity)
