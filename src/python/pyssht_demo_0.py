...
f_north_real, mask_north_real, f_south_real, mask_south_real, f_north_imag, mask_north_imag, f_south_imag, mask_south_imag = ssht.polar_projection(
    f, L, resolution=200, Method='MW', Projection='OP', rot=[0.0, np.pi / 2, 0.0])

plt.figure(1)
plt.subplot(2, 2, 1)
plt.imshow(f_north_real, interpolation='nearest')
plt.imshow(mask_north_real, interpolation='nearest',
...
plt.imshow(mask_north_imag, interpolation='nearest',
           cmap=cm.gray, vmin=-1., vmax=1.)
plt.axis('off')
...
plt.imshow(mask_south_real, interpolation='nearest',
           cmap=cm.gray, vmin=-1., vmax=1.)
plt.axis('off')
...
plt.imshow(mask_south_imag, interpolation='nearest',
           cmap=cm.gray, vmin=-1., vmax=1.)
plt.axis('off')
