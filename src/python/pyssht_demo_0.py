...
plt.imshow(mask_north_imag, interpolation='nearest', cmap=cm.gray, vmin=-1., vmax=1.)
plt.axis("off")
...
plt.imshow(mask_south_real, interpolation='nearest', cmap=cm.gray, vmin=-1., vmax=1.)
plt.axis("off")
plt.title("f West Real")

plt.subplot(2,2,4)
plt.imshow(f_south_imag,interpolation='nearest')
plt.imshow(mask_south_imag, interpolation='nearest', cmap=cm.gray, vmin=-1., vmax=1.)
plt.axis("off")
